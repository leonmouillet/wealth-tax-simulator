function Footer() {
  return (
    <footer className="footer">
      <p>
        Simulations and website built by <a href="mailto:le.mouillet@gmail.com">Léonard Mouillet</a>, 
        under the supervision of <a href="https://gabriel-zucman.eu/" target="_blank" rel="noopener noreferrer"> Gabriel Zucman</a>,
        at the{' '}
